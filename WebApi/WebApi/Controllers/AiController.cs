...
public class AiController : ControllerBase
{
    ...
    public async Task<IActionResult> Review([FromBody] AiReviewRequest request)
    {
        ...
        var prompt = $"אתגר בנושא: {request.ChallengeDescription}\n" +
                     ...
                     $"אתה מבקר אומנות AI.ואל תכנס לענינים רוחניים בכלל אתה צריך לתת חוות דעת עד כמה היצירה מתאימה לנושא האתגר תן חוות דעת עניינית ותמציתית  עם קצת הומור על היצירה לפי התיאור והנושא. אל תכלול המלצות, רעיונות לשיפור, או הערות נוספות.\r\n.\r\n";
