...
//            var token = _userService.GenerateJwtToken(user.UserId, user.Name, user.Email, ERole.User.ToString());
...
//            var token = _userService.GenerateJwtToken(user.UserId,user.Name,user.Email, user.Role.ToString());
